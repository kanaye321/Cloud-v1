...
export default function Assets() {
  ...
  useEffect(() => {
    ...
    const categoryParam = urlParams.get('categoryFilter');
    if (categoryParam && categoryParam !== 'all') {
      setCategoryFilter(categoryParam);
      hasFilters = true;
    }

    const departmentParam = urlParams.get('departmentFilter');
    if (departmentParam && departmentParam !== 'all') {
      setDepartmentFilter(departmentParam);
      hasFilters = true;
    }

    const conditionParam = urlParams.get('conditionFilter');
    ...
    // Clear URL parameters after filters are applied - only if filters were found
    if (hasFilters) {
